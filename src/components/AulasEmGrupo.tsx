      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 space-y-8 sm:space-y-10">
        ...
        <div className="space-y-3 max-w-2xl">
          <div className="flex items-center gap-3">
            ...
            <span className="uppercase tracking-[0.3em] text-[11px] sm:text-xs text-[#5D7C56] font-semibold">
              Prática Coletiva & Conexão
            </span>
          </div>

          <h2 className="font-serif text-3xl sm:text-4xl font-normal text-[#334230] tracking-tight">
            Aulas em Grupo
          </h2>

          <p className="text-sm sm:text-base text-[#616059] font-light leading-relaxed">
            Práticas pensadas para desenvolver presença, mobilidade, força e bem-estar em diferentes ritmos.
          </p>
        ...
        {/* 2. PROGRAMAÇÃO EM CARDS ÚNICOS E COMPLETOS */}
